...
describe Parser do
  ...
  describe '#create_list' do
    ...
    it 'creates a list and the logs stored on that list are a hash containing the onformation in the file. The file has two visits to the same page from the same ip_address.' do
      dir = File.dirname(__FILE__)
